...
import bawei.com.manhuazhuyepindaoguanli.TwoActivity;
...
public class WeekFragmentAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if( view == null ){
            ...
            viewHolder.quanji=(TextView)view.findViewById(R.id.quanji);
...
//        String labelColor =  list.get(position).getLabel_color() ;
        ...
        viewHolder.quanji.setOnClickListener(new View.OnClickListener() {
            @Override
